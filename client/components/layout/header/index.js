...
const Header = ({ className, ...props }) => {
    ...
    const { ref, toggleRef, isComponentVisible, setIsComponentVisible } = useComponentVisible(false);
        ...
        <header className={cn(styles.header, className)} {...props}>
            <div className={styles.container}>
                <div ref={toggleRef} className={styles.menuContainer}>
                    <Button className={styles.menu} onClick={() => setIsComponentVisible((isOpen) => !isOpen)}>
                ...
                <Button className={styles.logo} href="/">
                    <Logo />
                    <p>clone-of-stack<span>overflow</span></p>
                </Button>
